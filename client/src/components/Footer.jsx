      ...
      <div className="container mx-auto flex flex-col md:flex-row justify-start items-start px-4 md:px-15 lg:px-100 space-y-8 md:space-y-0">
        ...
        <div className="w-full md:w-1/4 mb-8 md:mb-0">
          ...
          <div className="flex space-x-4 text-2lg">
            <a href="https://twitter.com" className="text-white hover:text-gray-400 transition-colors duration-300">
            ...
            <a href="https://www.linkedin.com/in/deepak-kumar-2913a7257/" className="text-white hover:text-gray-400 transition-colors duration-300">
              <FaLinkedinIn className="text-2xl" />
            </a>
            <a href="https://github.com/deepakumar01" className="text-white hover:text-gray-400 transition-colors duration-300">
